...
class doublep(object):
    ...
    def __init__(self):
        _navigation_py.doublep_swiginit(self, _navigation_py.new_doublep())
    __swig_destroy__ = _navigation_py.delete_doublep

    def assign(self, value):
        return _navigation_py.doublep_assign(self, value)

    def value(self):
        return _navigation_py.doublep_value(self)

    def cast(self):
        return _navigation_py.doublep_cast(self)

    @staticmethod
    def frompointer(t):
        return _navigation_py.doublep_frompointer(t)

# Register doublep in _navigation_py:
_navigation_py.doublep_swigregister(doublep)
...
class intp(object):
    ...
    def __init__(self):
        _navigation_py.intp_swiginit(self, _navigation_py.new_intp())
    __swig_destroy__ = _navigation_py.delete_intp

    def assign(self, value):
        return _navigation_py.intp_assign(self, value)

    def value(self):
        return _navigation_py.intp_value(self)

    def cast(self):
        return _navigation_py.intp_cast(self)

    @staticmethod
    def frompointer(t):
        return _navigation_py.intp_frompointer(t)

# Register intp in _navigation_py:
_navigation_py.intp_swigregister(intp)
...
class stringp(object):
    ...
    def __init__(self):
        _navigation_py.stringp_swiginit(self, _navigation_py.new_stringp())
    __swig_destroy__ = _navigation_py.delete_stringp

    def assign(self, value):
        return _navigation_py.stringp_assign(self, value)

    def value(self):
        return _navigation_py.stringp_value(self)

    def cast(self):
        return _navigation_py.stringp_cast(self)

    @staticmethod
    def frompointer(t):
        return _navigation_py.stringp_frompointer(t)

# Register stringp in _navigation_py:
_navigation_py.stringp_swigregister(stringp)
...
class boolp(object):
    ...
    def __init__(self):
        _navigation_py.boolp_swiginit(self, _navigation_py.new_boolp())
    __swig_destroy__ = _navigation_py.delete_boolp

    def assign(self, value):
        return _navigation_py.boolp_assign(self, value)

    def value(self):
        return _navigation_py.boolp_value(self)

    def cast(self):
        return _navigation_py.boolp_cast(self)

    @staticmethod
    def frompointer(t):
        return _navigation_py.boolp_frompointer(t)

# Register boolp in _navigation_py:
_navigation_py.boolp_swigregister(boolp)
...
class MeasurementModelBase(gmatpy.gmat_py.GmatBase):
    r"""
...
class MeasureModel(gmatpy.gmat_py.GmatBase):
    r"""
    ...
    def CalculateMeasurementDerivatives(self, obj, id, forStrand=-1):
        return _navigation_py.MeasureModel_CalculateMeasurementDerivatives(self, obj, id, forStrand)
    ...
    def GetUplinkFrequency(self, pathIndex, rampTB):
        r""" Get uplink frequency and uplink band for a given signal path"""
        return _navigation_py.MeasureModel_GetUplinkFrequency(self, pathIndex, rampTB)

    def GetUplinkFrequencyAtReceivedEpoch(self, pathIndex, rampTB):
        return _navigation_py.MeasureModel_GetUplinkFrequencyAtReceivedEpoch(self, pathIndex, rampTB)

    def GetUplinkFrequencyBand(self, pathIndex, rampTB):
        return _navigation_py.MeasureModel_GetUplinkFrequencyBand(self, pathIndex, rampTB)
...
class Sensor(gmatpy.gmat_py.Hardware):
    r"""
...
class Antenna(gmatpy.gmat_py.Hardware):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
class ErrorModel(gmatpy.gmat_py.GmatBase):
    r"""
...
class SignalData(object):
    ...
    tSTMtm = property(_navigation_py.SignalData_tSTMtm_get, _navigation_py.SignalData_tSTMtm_set, doc=r""" The STM of transmit participant at measurement time tm(note that : measurement time tm is different from transmit time t1 and receive time t2 due to hardware delay)""")
    rSTMtm = property(_navigation_py.SignalData_rSTMtm_get, _navigation_py.SignalData_rSTMtm_set, doc=r""" The STM of receive participant at  measurement time tm(note that : measurement time tm is different from transmit time t1 and receive time t2 due to hardware delay)""")
    ...
    arriveFreq = property(_navigation_py.SignalData_arriveFreq_get, _navigation_py.SignalData_arriveFreq_set, doc=r""" signal frequencies Frequency (MHz) of the received signal at tNode's transponder. For the first signal leg, arrivedFreq is not used due to tNode is a transmiter only.""")
...
class SignalBase(gmatpy.gmat_py.GmatBase):
    r"""
    ...
    def ModelSignalDerivative(self, obj, forId):
        return _navigation_py.SignalBase_ModelSignalDerivative(self, obj, forId)
...
class PhysicalSignal(SignalBase):
    ...
    def ModelSignalDerivative(self, obj, forId):
        return _navigation_py.PhysicalSignal_ModelSignalDerivative(self, obj, forId)
